...
import { deleteAssignVideoApi, deleteChapterApi } from '../../utils/services';
import toast from 'react-hot-toast';


const DeleteAssignPrevVideoModal = ({ handleVideoList, item ,courseId}) => {
    ...
    const handleDelete = async () => {
        try {
            setLoading(true);
            const result = await deleteAssignVideoApi(item.id);
...
export default DeleteAssignPrevVideoModal