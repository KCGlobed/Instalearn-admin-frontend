...
import { handleAssignchapterlistApi, handleAssignchapterTopiclistApi } from "../../../utils/services";
...
// ------------------ Main Component ------------------
export default function NestedCourseBuilder({ prev, onSave }) {
    ...
    // Filter chapters and topics based on search
    ...
    const exportJSON = () => {
        const json = JSON.stringify(courseBuilder, null, 2);
