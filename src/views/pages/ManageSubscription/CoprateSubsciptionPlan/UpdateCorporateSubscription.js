...
import { handleGetCorporateDetailSubscriptionPlan, handleGetStudentDetailSubscriptionPlan, handleUpdateCorporateSubscriptionPlan, handleUpdateStudentSubscriptionPlan, handleUpdateUniversitySubscriptionPlan } from '../../../../utils/services';
import { useNavigate, useParams } from 'react-router-dom';
import toast from 'react-hot-toast';

const { Option } = Select;

const UpdateCorporateSubscription = () => {
    ...
    const fetchPlanDetails = async (id) => {
        try {
            const response = await handleGetCorporateDetailSubscriptionPlan(id);
...
export default UpdateCorporateSubscription;