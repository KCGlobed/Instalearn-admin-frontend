...
import { handleCreateStudentSubscriptionApi, handleCreateUniversirtySubscriptionApi } from '../../../../utils/services';
import toast from 'react-hot-toast';
import { useNavigate } from 'react-router-dom';

const { Option } = Select;

const AddUnviersityPlan = () => {
  ...
  const onFinish = async (values) => {
    setLoading(true);
    try {
      await handleCreateUniversirtySubscriptionApi(values);
          ...
          <Card className='prev-card ' title="Plan Preview" style={{ position: 'sticky', top: 68 }}>
            {formValues.plan_name ? (
              ...
              <div style={{ textAlign: 'center', color: '#888', padding: '40px 0' }}>
                ...
                <p>of your Unversity plan here</p>
              </div>
            )}
          </Card>
        </Col>
...
export default AddUnviersityPlan;