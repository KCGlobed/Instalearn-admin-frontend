...
import { handleGetCorporateDetailSubscriptionPlan, handleGetStudentDetailSubscriptionPlan, handleGetUniversityDetailSubscriptionPlan, handleUpdateCorporateSubscriptionPlan, handleUpdateStudentSubscriptionPlan, handleUpdateUniversitySubscriptionPlan } from '../../../../utils/services';
import { useNavigate, useParams } from 'react-router-dom';
import toast from 'react-hot-toast';

const { Option } = Select;

const UpdateUniversityPlan = () => {
    ...
    const onFinish = async (values) => {
        setLoading(true);
        try {
            await handleUpdateUniversitySubscriptionPlan(values, id);
    ...
    const fetchPlanDetails = async (id) => {
        try {
            const response = await handleGetUniversityDetailSubscriptionPlan(id);
                    ...
                    <Card className='prev-card' title="Plan Preview" style={{ position: 'sticky', top: 68 }}>
                        {formValues.plan_name ? (
                            ...
                            <div style={{ textAlign: 'center', color: '#888', padding: '40px 0' }}>
                                ...
                                <p>of your Corporate plan here</p>
                            </div>
                        )}
                    </Card>
                </Col>
...
export default UpdateUniversityPlan;