...
const PaymentPlan = () => {
    ...
    const columns = [
        ...
        { title: "Plan Name", dataIndex: "age", key: "age", width: 100, sorter: (a, b) => a.age - b.age },
        { title: "Price", dataIndex: "email", key: "email", width: 150 },
      
        { title: "Billing Cycle", dataIndex: "address", key: "address", width: 150 },
        { title: "Description", dataIndex: "city", key: "city", width: 150 },
        { title: "Subscription", dataIndex: "city", key: "city", width: 150 },
        { title: "Gross Price", dataIndex: "city", key: "city", width: 150 },
        { title: "Gross Amount Tax", dataIndex: "state", key: "state", width: 150 },
        { title: "Net Tax", dataIndex: "country", key: "country", width: 150 },
        { title: "Created Date", dataIndex: "pincode", key: "pincode", width: 150 },
        { title: "Updated Date ", dataIndex: "last_Login", key: "last_Login", width: 150 },
    ...
    return (
        <div className="fancy-table-container">
            ...
            />
            <AddPaymentPlanModal visible={isAddModalVisible} onCancel={() => setIsAddModalVisible(false)} />
            <EditPaymentPlanModal visible={isEditModalVisible} selectedCourse={selectedCourse} onCancel={() => setIsEditModalVisible(false)} />
        </div>
    );
};
